...
.EXAMPLE
    .\db-create.ps1 -V8Path "C:\Program Files\1cv8\8.3.27.1644\bin" -InfoBaseServer "<server-host>" -InfoBaseRef "<infobase-ref>"

.EXAMPLE
    .\db-create.ps1 -V8Path "C:\Program Files\1cv8\8.3.27.1644\bin" -InfoBaseServer "<server-host>" -InfoBaseRef "<infobase-ref>" -UseTemplate "C:\Templates\config.cf"
#>
